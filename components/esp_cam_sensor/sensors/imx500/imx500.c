...
static const esp_cam_sensor_format_t imx500_format_info[] = {
...
#else
    {
        ...
        .width = 1920,
        .height = 1080,
        .regs = o5647_input_24M_MIPI_2lane_raw10_1920x1080_30fps,
        .regs_size = ARRAY_SIZE(o5647_input_24M_MIPI_2lane_raw10_1920x1080_30fps),
        .fps = 30,
        .isp_info = &imx500_isp_info[0],
        .mipi_info = {
            .mipi_clk = 745000000, //O5647_MIPI_CSI_LINE_RATE_1920x1080_30FPS,
            .lane_num = 2,
            .line_sync_en = CONFIG_CAMERA_IMX500_CSI_LINESYNC_ENABLE ? true : false,
        },
        .reserved = NULL,
